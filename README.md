...
Sou formado em **Sistemas para Internet (SPI)** e em **Logística**, e atualmente curso **Licenciatura em Computação** no IFTM. Minha especialidade é **Desenvolvimento Web**, unindo a visão de processos logísticos à construção de aplicações robustas.
...
### 📊 Estatísticas:
![Estatísticas do Hugo](https://github-readme-stats.vercel.app/api?username=HugoRibeiro-estudante&show_icons=true&theme=dark&include_all_commits=true&count_private=true)
